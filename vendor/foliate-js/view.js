...
export const makeBook = async file => {
    ...
    // READ.html patch: non-EPUB format branches removed (CBZ, FB2/FBZ, PDF,
    // MOBI) so their modules are excluded from the bundle. See VENDORED.md.
...
export class View extends HTMLElement {
    ...
    // READ.html patch: initTTS() removed (tts.js excluded). See VENDORED.md.
    startMediaOverlay() {
